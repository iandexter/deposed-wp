...
<?php if (($comments) or ('open' == $post-> comment_status)) { ?>
  <div id="comments" class="post"><h3 class="comments_headers"><?php comments_number('No Comments Yet', '1 Comment', '% Comments' );?></h3></div>
  <?php if ($comments) { ?>
    <?php $count_pings = 1; foreach ($comments as $comment) { ?>
      <div class="postcomment">
        ...
        <p>Posted on <?php comment_date('j F Y at g:i A T') ?></p>
  ...
  <?php } else { // this is displayed if there are no comments so far ?>
    <?php if ('open' == $post-> comment_status) { ?> 
      <br clear="left" />
      <div class="content"><p>Be the first to comment!</p></div>
